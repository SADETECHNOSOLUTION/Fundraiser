        ...
        return (
          <div className="w-full max-w-md mx-auto">
            <div className="bg-gray-200 rounded-full h-2 w-full relative">
              ...
              ></div>
              <span className="absolute bottom-[-1.5rem] right-0 text-sm text-">
                {progress}%
              </span>
              <span className="absolute bottom-[-1.5rem] left-0 text-sm text-">
               27 days left
              </span>
            </div>
          </div>
...
<div className="bg-background bg-opacity-80 text-white p-2 w-full med:w-5/6 h-20 rounded-xl med:absolute bottom-0 medium:bottom-36">


<div className="flex items-center  justify-between">
<span className="text-white text-sm sl:text-white font-[600]"> {fund.amount}</span>
<div className="flex items-center">
<div className="relative flex items-center text-white w-16 h-8 ">
<img alt="" src="persona1.jpg" className="rounded-full w-6 h-6 absolute left-2 border-white" />
<img  alt="" src="persona2.jpg" className="rounded-full w-6 h-6 absolute left-6 border-white border-2   " />
</div>
...
<div className="med:h-12">

</div>
<div className="flex flex-col mb-5 gap-2 p-3">
<p className="text-base  font-[600]">{fund.heading}</p>
<div className=" max-w">
<span className="line-clamp-1 hidden sl:flex text-sm">{fund.description}</span>
</div>
